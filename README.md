...
VSIX asset: `eta-ejs-prettifier-1.2.1.vsix`
...
- VSIX download: `https://github.com/KEYHAN-A/eta-prettifier/releases/download/v1.2.1/eta-ejs-prettifier-1.2.1.vsix`
