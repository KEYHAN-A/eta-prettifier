...
- Current stable target: `v1.1.0` (`eta-ejs-prettifier-1.1.0.vsix`)
...
4. Validate release asset link:
   - `https://github.com/KEYHAN-A/eta-prettifier/releases/download/v1.1.0/eta-ejs-prettifier-1.1.0.vsix`
